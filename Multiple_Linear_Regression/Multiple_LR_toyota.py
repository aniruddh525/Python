...
rsq_qtax = smf.ols('Quarterly_Tax~Age+KM+HP+cc+Doors+Gears+Weight',data=toyota).fit().rsquared  
vif_qtax = 1/(1-rsq_qtax)

rsq_wt = smf.ols('Weight~Age+KM+HP+cc+Doors+Gears+Quarterly_Tax',data=toyota).fit().rsquared  
vif_wt = 1/(1-rsq_wt)

# Storing vif values in a data frame
d1 = {'Variables':['Age','KM','HP','cc','doors','Gears','Qtax','Wt'],
      'VIF':[vif_age,vif_km,vif_hp,vif_cc,vif_doors,vif_gears,vif_qtax,vif_wt]}
